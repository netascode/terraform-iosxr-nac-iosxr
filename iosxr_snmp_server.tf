resource "iosxr_snmp_server" "snmp_server" {
  ...
  engine_id_remotes = try(length(local.device_config[each.value.name].snmp_server.engine_id_remotes) == 0, true) ? null : [for remote in local.device_config[each.value.name].snmp_server.engine_id_remotes : {
    address   = try(remote.address, null)
    engine_id = try(remote.engine_id, null)
    udp_port  = try(remote.udp_port, null)
    }
  ]
  groups = try(length(local.device_config[each.value.name].snmp_server.groups) == 0, true) ? null : [for group in local.device_config[each.value.name].snmp_server.groups : {
    ...
    v1          = try(group.v1, null)
    v1_read     = try(group.v1_read, null)
    v1_write    = try(group.v1_write, null)
    v1_context  = try(group.v1_context, null)
    v1_notify   = try(group.v1_notify, null)
    v1_ipv4     = try(group.v1_ipv4, null)
    v1_ipv6     = try(group.v1_ipv6, null)
    v2c         = try(group.v2c, null)
    v2c_read    = try(group.v2c_read, null)
    v2c_write   = try(group.v2c_write, null)
    v2c_context = try(group.v2c_context, null)
    v2c_notify  = try(group.v2c_notify, null)
    v2c_ipv4    = try(group.v2c_ipv4, null)
    v2c_ipv6    = try(group.v2c_ipv6, null)
  ...
  hosts = try(length(local.device_config[each.value.name].snmp_server.hosts) == 0, true) ? null : [for host in local.device_config[each.value.name].snmp_server.hosts : {
    ...
    traps_unencrypted_strings = try(length(host.traps_unencrypted_strings) == 0, true) ? null : [for trap in host.traps_unencrypted_strings : {
      community_string          = try(trap.community_string, null)
      udp_port                  = try(trap.udp_port, null)
      version_v2c               = try(trap.version_v2c, null)
      version_v3_security_level = try(trap.version_v3_security_level, null)
      }
    ]
    informs_unencrypted_strings = try(length(host.informs_unencrypted_strings) == 0, true) ? null : [for inform in host.informs_unencrypted_strings : {
      community_string          = try(inform.community_string, null)
      udp_port                  = try(inform.udp_port, null)
      version_v2c               = try(inform.version_v2c, null)
      version_v3_security_level = try(inform.version_v3_security_level, null)
      }
    ]
    }
  ]
  users = try(length(local.device_config[each.value.name].snmp_server.users) == 0, true) ? null : [for user in local.device_config[each.value.name].snmp_server.users : {
    ...
    v1                                     = try(user.v1, null)
    v1_ipv4                                = try(user.v1_ipv4, null)
    v1_ipv6                                = try(user.v1_ipv6, null)
    v1_systemowner                         = try(user.v1_systemowner, null)
    v2c                                    = try(user.v2c, null)
    v2c_ipv4                               = try(user.v2c_ipv4, null)
    v2c_ipv6                               = try(user.v2c_ipv6, null)
    v2c_systemowner                        = try(user.v2c_systemowner, null)
    v3                                     = try(user.v3, null)
    ...
    v3_auth_sha_256_encryption_aes         = try(user.v3_auth_sha_256_encryption_aes, null)
    v3_auth_sha_256_encryption_default     = try(user.v3_auth_sha_256_encryption_default, null)
    v3_auth_sha_512_encryption_aes         = try(user.v3_auth_sha_512_encryption_aes, null)
    v3_auth_sha_512_encryption_default     = try(user.v3_auth_sha_512_encryption_default, null)
    v3_ipv4                                = try(user.v3_ipv4, null)
    v3_ipv6                                = try(user.v3_ipv6, null)
    ...
    v3_priv_aes_aes_192_encryption_aes     = try(user.v3_priv_aes_aes_192_encryption_aes, null)
    v3_priv_aes_aes_192_encryption_default = try(user.v3_priv_aes_aes_192_encryption_default, null)
    v3_priv_aes_aes_256_encryption_aes     = try(user.v3_priv_aes_aes_256_encryption_aes, null)
    v3_priv_aes_aes_256_encryption_default = try(user.v3_priv_aes_aes_256_encryption_default, null)
