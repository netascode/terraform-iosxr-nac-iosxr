locals {
  ...
  device_main_interfaces = flatten([
    for interface in local.device_interfaces_group : {
      ...
      ipv4_access_group_ingress_compress_level                 = try(interface.configuration.ipv4_access_group_ingress_compress_level, local.defaults.iosxr.configuration.interface.ipv4_access_group_ingress_compress_level, null)
      ...
      ipv4_access_group_egress_compress_level                  = try(interface.configuration.ipv4_access_group_egress_compress_level, local.defaults.iosxr.configuration.interface.ipv4_access_group_egress_compress_level, null)
      ...
      ipv6_access_group_ingress_compress_level       = try(interface.configuration.ipv6_access_group_ingress_compress_level, local.defaults.iosxr.configuration.interface.ipv6_access_group_ingress_compress_level, null)
      ipv6_access_group_egress_acl1                  = try(interface.configuration.ipv6_access_group_egress_acl1, local.defaults.iosxr.configuration.interface.ipv6_access_group_egress_acl1, null)
      ...
      ipv6_access_group_egress_compress_level        = try(interface.configuration.ipv6_access_group_egress_compress_level, local.defaults.iosxr.configuration.interface.ipv6_access_group_egress_compress_level, null)
