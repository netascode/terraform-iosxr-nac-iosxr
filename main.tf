...
resource "iosxr_cli" "cli_0" {
  ...
  depends_on = [
    ...
    iosxr_error_disable_recovery.error_disable_recovery,
    iosxr_esi_set.esi_set,
    iosxr_etag_set.etag_set,
    iosxr_evpn.evpn,
    iosxr_evpn_evi.evpn_evi,
    iosxr_evpn_interface.evpn_interface,
    ...
    iosxr_interface_ethernet.ethernet_unmanaged,
    ...
    iosxr_line_console.line_console,
    iosxr_line_default.line_default,
    iosxr_line_template.line_template,
    ...
    iosxr_router_hsrp_interface_ipv4_group_v2.router_hsrp_interface_ipv4_group_v2,
    iosxr_router_hsrp_interface_ipv6_group_v2.router_hsrp_interface_ipv6_group_v2,
