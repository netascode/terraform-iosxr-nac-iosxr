    ...
    - name: router-1
      ...
      configuration:
        ...
        logging:
          ...
          trap: informational
          monitor: disable
          monitor_discriminator_match1: MONITOR_MATCH1
          monitor_discriminator_match2: MONITOR_MATCH2
          monitor_discriminator_match3: MONITOR_MATCH3
          monitor_discriminator_nomatch1: MONITOR_NOMATCH1
          monitor_discriminator_nomatch2: MONITOR_NOMATCH2
          monitor_discriminator_nomatch3: MONITOR_NOMATCH3
          archive_disk0: true
