  ...
  evpn_evis = flatten([
    for device in local.devices : [
      for evi in try(local.device_config[device.name].evpn_evis, []) : {
        ...
        bgp_rd_two_byte_as_assigned_number  = try(evi.bgp_rd_two_byte_as_assigned_number, local.defaults.iosxr.devices.configuration.evpn_evis.bgp_rd_two_byte_as_assigned_number, null)
        ...
        bgp_rd_four_byte_as_assigned_number = try(evi.bgp_rd_four_byte_as_assigned_number, local.defaults.iosxr.devices.configuration.evpn_evis.bgp_rd_four_byte_as_assigned_number, null)
        ...
        bgp_rd_ipv4_address_assigned_number = try(evi.bgp_rd_ipv4_address_assigned_number, local.defaults.iosxr.devices.configuration.evpn_evis.bgp_rd_ipv4_address_assigned_number, null)
