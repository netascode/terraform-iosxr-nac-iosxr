    ...
    for device in local.devices : [
      for bgp_process in try(local.device_config[device.name].routing.bgp, []) : {
        ...
        neighbors = try(length(bgp_process.neighbors) == 0, true) ? null : [for neighbor in bgp_process.neighbors : {
          ...
          bfd_fast_detect                                                   = try(neighbor.bfd_fast_detect, local.defaults.iosxr.devices.configuration.routing.bgp.neighbors.bfd_fast_detect, null)
          bfd_fast_detect_strict_mode                                       = try(neighbor.bfd_fast_detect_strict_mode, local.defaults.iosxr.devices.configuration.routing.bgp.neighbors.bfd_fast_detect_strict_mode, null)
          bfd_fast_detect_disable                                           = try(neighbor.bfd_fast_detect_disable, local.defaults.iosxr.devices.configuration.routing.bgp.neighbors.bfd_fast_detect_disable, null)
          bfd_fast_detect_strict_mode_negotiate                             = try(neighbor.bfd_fast_detect_strict_mode_negotiate, local.defaults.iosxr.devices.configuration.routing.bgp.neighbors.bfd_fast_detect_strict_mode_negotiate, null)
          bfd_fast_detect_strict_mode_negotiate_override                    = try(neighbor.bfd_fast_detect_strict_mode_negotiate_override, local.defaults.iosxr.devices.configuration.routing.bgp.neighbors.bfd_fast_detect_strict_mode_negotiate_override, null)
          ...
          log_neighbor_changes_detail                                       = try(neighbor.log_neighbor_changes_detail, local.defaults.iosxr.devices.configuration.routing.bgp.neighbors.log_neighbor_changes_detail, null)
          log_neighbor_changes_disable                                      = try(neighbor.log_neighbor_changes_disable, local.defaults.iosxr.devices.configuration.routing.bgp.neighbors.log_neighbor_changes_disable, null)
          log_neighbor_changes_inheritance_disable                          = try(neighbor.log_neighbor_changes_inheritance_disable, local.defaults.iosxr.devices.configuration.routing.bgp.neighbors.log_neighbor_changes_inheritance_disable, null)
          ...
          cluster_id_32bit_format                                           = try(neighbor.cluster_id_32bit_format, local.defaults.iosxr.devices.configuration.routing.bgp.neighbors.cluster_id_32bit_format, null)
          cluster_id_ip_format                                              = try(neighbor.cluster_id_ip_format, local.defaults.iosxr.devices.configuration.routing.bgp.neighbors.cluster_id_ip_format, null)
        ...
        nexthop_validation_color_extcomm_sr_policy = try(bgp_process.nexthop_validation_color_extcomm_sr_policy, local.defaults.iosxr.devices.configuration.routing.bgp.nexthop_validation_color_extcomm_sr_policy, null)
        nexthop_validation_color_extcomm_disable   = try(bgp_process.nexthop_validation_color_extcomm_disable, local.defaults.iosxr.devices.configuration.routing.bgp.nexthop_validation_color_extcomm_disable, null)
        ...
        bgp_bestpath_sr_policy_prefer              = try(bgp_process.bgp_bestpath_sr_policy_prefer, local.defaults.iosxr.devices.configuration.routing.bgp.bgp_bestpath_sr_policy_prefer, null)
        bgp_bestpath_sr_policy_force               = try(bgp_process.bgp_bestpath_sr_policy_force, local.defaults.iosxr.devices.configuration.routing.bgp.bgp_bestpath_sr_policy_force, null)
        bgp_cluster_id_32bit_format                = try(bgp_process.bgp_cluster_id_32bit_format, local.defaults.iosxr.devices.configuration.routing.bgp.bgp_cluster_id_32bit_format, null)
        bgp_cluster_id_ip_format                   = try(bgp_process.bgp_cluster_id_ip_format, local.defaults.iosxr.devices.configuration.routing.bgp.bgp_cluster_id_ip_format, null)
        ...
        bgp_log_neighbor_changes_detail            = try(bgp_process.bgp_log_neighbor_changes_detail, local.defaults.iosxr.devices.configuration.routing.bgp.bgp_log_neighbor_changes_detail, null)
        bgp_log_neighbor_changes_disable           = try(bgp_process.bgp_log_neighbor_changes_disable, local.defaults.iosxr.devices.configuration.routing.bgp.bgp_log_neighbor_changes_disable, null)
